...
public class ModifiedTest
{
    ...
    public static void StartGameWithNumber(int number)
    {
        ...
        //Game and level to play(THIS IS MODIFIED FROM ORIGINAL, RECEIVES NUMBER BY PARAMETER)
        int gameIdx = number;
